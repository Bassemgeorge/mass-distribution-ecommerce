...
export default function ProductPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    async function load() {
      ...
      const { data: relDb } = await getProducts({
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-[#F7F7F5] border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link
            href="/products"
            className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-[#1B4D2E] font-medium transition-colors"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-base text-gray-400 mb-6 text-right" dir="rtl">
              {product.nameAr}
            </p>
            ...
            <div className="flex items-center gap-3 bg-[#E8F5E9] border border-green-200 rounded-xl px-4 py-3 mb-4">
              ...
              <div>
                <p className="text-sm font-semibold text-[#1B4D2E]">
                  Case contains: {product.caseCount} pcs
                </p>

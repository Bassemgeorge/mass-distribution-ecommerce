...
export default function HomePage() {
  const featured = ["1", "64", "86", "94", "122", "135", "152", "30"]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="max-w-2xl">
            ...
            <p className="text-white/70 text-base md:text-lg mb-2 leading-relaxed">
              {products.length} products across {brands.length} top brands — delivered to your door across Egypt.
            </p>
            <p className="text-white/50 text-sm mb-10" dir="rtl">
              {products.length} منتج من {brands.length} علامات تجارية — توصيل لجميع أنحاء مصر
            </p>
            ...
            {categories.map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <p className="font-medium text-xs text-gray-800 leading-tight">{cat}</p>
      ...
      <section className="bg-[#F7F7F5] py-16 border-t border-gray-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {[
              { step: "01", icon: Search,       title: "Browse",   titleAr: "تصفح",  desc: "Explore 237 products across 9 top HORECA brands. Filter by category or brand." },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-8">
            ...
            <Link href="/products" className="hidden sm:inline-flex items-center gap-1 text-sm font-medium text-[#1B4D2E] hover:underline">
              View all {products.length} <ArrowRight size={15} />
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { icon: Package,     title: "9 Top Brands, 237 Products", titleAr: "9 علامات تجارية، 237 منتج", desc: "Wadifood, Knorr, Heinz, Savola, Pepsi, El Doha, Nestle and more — all in one place." },
      ...
      <section className="bg-[#1B4D2E] text-white py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-white/70 mb-8 text-base">
            800+ clients. 4,000+ touchpoints. Nationwide reach across Egypt.
          </p>
